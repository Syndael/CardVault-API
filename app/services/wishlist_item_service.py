...
class WishlistItemService(CrudService):
    ...
    def get_paginated_by_user(cls, user_id, page, per_page):
        ...
        query = query.options(
            ...
            selectinload(WishlistItemModel.product).joinedload(ProductModel.collection).joinedload(CollectionModel.card_type),
            selectinload(WishlistItemModel.product).joinedload(ProductModel.product_type),
